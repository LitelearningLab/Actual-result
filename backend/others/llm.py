...
def descriptive_evaluation(api_client, question_mark, expected_answer, student_answer):
    ...
    user_message = f'''
        ...
        **Candidate's Answer:** {student_answer}
        ...
        "missing": "<comma-separated list of completely missing points or 'None'>",
        "incomplete": "<comma-separated list of mentioned but incomplete points or 'None'>",
        "incorrect": "<comma-separated list of factually incorrect statements or 'None'>",
