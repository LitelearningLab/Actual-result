-- Review availability and visibility settings used by the scheduling API.
-- This migration must run before the multiple/manual-review migrations.
...
IF COL_LENGTH('dbo.ExamSchedules', 'show_score') IS NULL
    ALTER TABLE dbo.ExamSchedules ADD show_score BIT NOT NULL
        CONSTRAINT DF_ExamSchedules_show_score DEFAULT (1) WITH VALUES;
GO

IF COL_LENGTH('dbo.ExamSchedules', 'show_correct_answers') IS NULL
    ALTER TABLE dbo.ExamSchedules ADD show_correct_answers BIT NOT NULL
        CONSTRAINT DF_ExamSchedules_show_correct_answers DEFAULT (1) WITH VALUES;
GO

IF COL_LENGTH('dbo.ExamSchedules', 'show_student_answers') IS NULL
    ALTER TABLE dbo.ExamSchedules ADD show_student_answers BIT NOT NULL
        CONSTRAINT DF_ExamSchedules_show_student_answers DEFAULT (1) WITH VALUES;
GO

IF COL_LENGTH('dbo.ExamSchedules', 'show_explanations') IS NULL
    ALTER TABLE dbo.ExamSchedules ADD show_explanations BIT NOT NULL
        CONSTRAINT DF_ExamSchedules_show_explanations DEFAULT (1) WITH VALUES;
GO
